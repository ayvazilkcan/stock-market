...
public final class StockMarketExceptionMessage {

    private StockMarketExceptionMessage(){}

    public static final String STOCK_EXCHANGE_ALREADY_EXIST_MSG = "Stock Exchange already exist.";
